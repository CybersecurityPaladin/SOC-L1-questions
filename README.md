...
Is a security protocol that provides privacy(enceyption), integrity(hashing) and  authenication(authentication). SSL is older version of TLS. 
...
is an attack that forces authenticated users to submit a request to a web application against. 
...
<ins>**33: Bypass firewall/ids**</ins>  
HTTPS or SSH tunnels to hide data inside allowed traffic, split packets to avoid detection, or run slow scans so IDS doesn’t trigger alerts.   
**Detect it by looking for anomalies:** unusual traffic patterns, unexpected outbound connections, beaconing behavior, or suspicious use of normally legitimate protocols

<ins>**34: Fragmentation attack**</ins>  
is when an attacker splits malicious payload into multiple IP fragments to bypass IDS inspection and evade signature-based detection.

<ins>**35: Security Misconfiguration**</ins>  
is a security vulnerability caused by incomplete or incorrect configuration.

<ins>**36: Compliance**</ins>  
Following the set of standards authorized by an organization or government.

<ins>**37: MITRE ATT&CK®**</ins>  
is a knowledge base of adversary tactics and techniques based on real-world observations. 

<ins>**38:  Cyber Kill Chain**</ins>  
...
<ins>**40: (EDR) Endpoint detection & response**</ins>  
is a proactive cybersecurity technology that helps identify, respond to, and mitigate cyberthreats on devices. (CrowdStrike, Microsoft Defender, SentinelOne). 

<ins>**41: What steps do you take when you identify a security incident?**</ins>  
...
<ins>**46: (MAC) MEDIA ACCESS CONTROL**</ins>  
...
<ins>**47: Address Resolution Pr. (ARP)**</ins>  
...
<ins>**49: Dynamic Host Configuration Protocol**</ins>  
...
<ins>**50: Internet Protocol (IP)**</ins>  
...
<ins>**52: Open Worldwide Application Security Project**</ins>  
is a standard awareness document for developers and web application security. ([OWASP](https://owasp.org/))

<ins>**53: (IDOR) Insecure Direct Object Reference**</ins>  
...
<ins>**54: (RFI) Remote File Inclusion**</ins>  
...
<ins>**55: (LFI) Local File Inclusion**</ins>  
...
<ins>**59: Static and dynamic malware analysis**</ins>  
...
<ins>**60: (CTI) Cyber Threat intelligence**</ins>  
...
<ins>**61: (TAXII) Trusted Automated eXchange of Intelligence Information**</ins>  
defines how cyber threat information can be shared via services and message exchanges.

<ins>**62: Types of Threat Intelligence**</ins>  
➣ **Strategic** Threat Intelligence.  
➣ **Tactical** Threat Intelligence.  
➣ **Technical** Threat Intelligence.   
➣ **Operational** Threat Intelligence.  

<ins>**63: Linux Paths**</ins>  
...
<ins>**67: What would you do if you see a suspicious PS commands? Which one are suspicious?**</ins>  
...
<ins>**71: Data transmission methods(layer 2)**</ins>  
...
<ins>**73: Why deleted data not deleted**</ins>  
...
<ins>**81: BitLocker**</ins>  
Is a Windows security feature that protects your data by encrypting your drives

<ins>**82: Detect malicious activity around both SAM and passwd/shadow file?**</ins>  
**Windows:**  
...
<ins>**84: Authentication protocols**</ins>  
...
<ins>**85: Would you Encrypt and Compress or Compress and Encrypt?**</ins>  
...
<ins>**86: (SLA) Service level agreement**</ins>  
is a contract between a service provider and a customer

<ins>**87: What would you do if you detected a phishing email?**</ins>  
...
<ins>**88: You discover user clicked links in phishing email, also shared credentials.**</ins>  
...
<ins>**89: SPM DKIM DMARC records are related to?**</ins>  
...
<ins>**90: How can you determine if the email spam? What is the action taken to arrest the spread of same if you have to act?**</ins>  
...
<ins>**91: Make a playbook for case of BEC (Business Email Compromise)**</ins>  
...
<ins>**92: What is Process Injection? Name some methods**</ins>  
...
<ins>**93: How would you classify a website as malicious?**</ins>  
...
<ins>**94: What is drive-by-downloads?**</ins>  
unintentional download of malicious code

<ins>**95: Can website with Green-Lock (SSL) be dangerous?**</ins>  
HTTPS only encrypts the connection but does not guarantee that the website itself is safe or trustworthy.

<ins>**96: You discover your infrastructure is under DDoS attack. What will be your resonse plan?**</ins>  
...
<ins>**97: What are different DNS Records?**</ins>  
...
<ins>**98: Application and OS are Vulnerable, which one will you priotize to fix and why?**</ins>  
...
<ins>**99: Can you do Network backet Analysis of HTTPS (SSL Enabled) traffic with Wireshark?**</ins>  
...
<ins>**103: What happens when you open a website**</ins>  
...
<ins>**20: Structured Query Language Injection**</ins>  
is an attack where inserts malicious SQL code into input fields to manipulate database queries.  
**In-Band** sql query is sent and a replied to over the same channel.  
**Inferential (Blind)** attacker infers information by observing application behavior via response differences or timing.  
**Out-Of-Band.** Query is communicated over a different channel (ex. via DNS).  
**Prevent:** Never concatenate user input into SQL. Validate input and disable detailed database errors.
