...
Responsibilities include monitoring security alerts, investigating potential threats, conducting vulnerability assessments, responding to incidents. It's a mix of proactive and reactive tasks aimed at keeping the organization safe.

<ins>**2: (VA) Vulnerability assessment**</ins>  
is the process of identifying and evaluating security weaknesses in systems to determine their severity and prioritize remediation.

<ins>**3: How do you handle working with team members who have different opinions?**</ins>  
I listen actively to understand their perspectives, share my viewpoints clearly, and look for common ground. The goal is to work towards a solution that benefits the team and the organization, even if it means compromising on certain aspects.

<ins>**4: What if Someone Yelling**</ins>  
I would stay professional, not respond emotionally, and try to de-escalate the situation. If the behavior continues, I would report it through the appropriate channels according to company policy.  
“I’m happy to discuss the issue, but I’d prefer we keep the conversation first of all respectful.”
...
Windows logs for SOC are event records generated by the Windows operating system and applications that provide visibility into authentication.  
